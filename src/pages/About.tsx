  ...
  return (
    <Layout>
      <SEOHead
        ...
        description={isAr
          ? "تعرف على أيوب التواتي، خبير رقمي مقره مكناس. تصميم مواقع، SEO وتطوير ووردبريس."
          : "Découvrez Ayoub Touati, expert digital basé à Meknès. Création de sites web, SEO et développement WordPress."}
        path="/a-propos"
      />

  ...
  return (
    <Layout>
      <SEOHead
        ...
        description={isAr
          ? `مبرمج مستقل في ${city.nameAr}، وليس وكالة. تصميم مواقع، SEO، ووردبريس. تواصل مباشر معي، بلا مصاريف وكالة. عرض سعر مجاني خلال 24 ساعة.`
          : `Développeur freelance à ${city.name}, pas une agence : sites web, SEO, WordPress. Contact direct avec moi, devis gratuit sous 24h, sans frais d'agence.`}
        ...
        <div className="container">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="prose prose-lg text-muted-foreground space-y-4">
              ...
              <p>
                {isAr
                  ? `أساعد الشركات في ${city.nameAr} على التميز عبر الإنترنت بمواقع سريعة، استراتيجيات SEO فعالة ومرافقة ووردبريس — بتكلفة مستقل، بلا هامش وكالة.`
                  : `J'aide les entreprises à ${city.name} à se démarquer en ligne grâce à des sites performants, des stratégies SEO efficaces et un accompagnement WordPress — au tarif d'un freelance, sans la marge d'une agence.`}
              </p>
            </div>
            <div className="mt-8">

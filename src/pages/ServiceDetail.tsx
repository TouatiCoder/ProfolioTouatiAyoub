  ...
  return (
    <Layout>
      <SEOHead
        ...
        description={isAr
          ? `${service.shortDescAr} من مبرمج مستقل، وليس وكالة. تواصل مباشر معي للحصول على عرض سعر مخصص خلال 24 ساعة.`
          : (service.metaDescription ?? `${service.shortDesc} par un développeur freelance, pas une agence. Contact direct avec moi pour un devis personnalisé sous 24h.`)}
        path={`/services/${service.slug}`}
        ...
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-6 flex items-center justify-center gap-1 text-accent">
              ...
              <span className="ml-2 text-sm text-primary-foreground/60">{isAr ? "مشاريع ناجح" : "projets réussis"}</span>
            </div>
            {serviceImage && (
        ...
        <div className="container">
          ...
          <div className="mx-auto grid max-w-4xl gap-6 md:grid-cols-3">
            <div className="rounded-xl border border-border/50 bg-card p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground">{isAr ? "مشاريع ناجحة مع عائد استثمار قابل للقياس" : "Projets livrés avec des résultats suivis"}</p>
            </div>
            <div className="rounded-xl border border-border/50 bg-card p-6 text-center">

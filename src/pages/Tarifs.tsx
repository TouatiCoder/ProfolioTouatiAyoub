  ...
  return (
    <Layout>
      <SEOHead
        ...
        description={
          isAr
            ? "اكتشف الأسعار الأولية لتصميم المواقع، SEO، إعادة التصميم وتطوير ووردبريس بالمغرب. عرض سعر مجاني ومخصص فأقل من 24 ساعة."
            : "Découvrez les tarifs indicatifs pour la création de site web, le SEO, la refonte et le développement WordPress au Maroc. Devis gratuit et personnalisé sous 24h."
        }
        path="/tarifs"
